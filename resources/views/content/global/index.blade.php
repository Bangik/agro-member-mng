...
<body>
        ...
        <div class="container">
            <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <!-- navbar button: Start -->
                    <li>
                        <a href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo-1/auth/login-cover"
                            class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4" target="_blank">
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="landingHero" class="section-py landing-hero position-relative">
            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/backgrounds/hero-bg-light.png"
            ...
            <div class="container">
                ...
                <div class="position-relative hero-animation-img">
                    <a href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo-1/app/ecommerce/dashboard"
                        target="_blank">
                        <div class="hero-dashboard-img text-center">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/hero-dashboard-light.png"
                        ...
                        <div class="position-absolute hero-elements-img">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/hero-elements-light.png"
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
                    <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/section-title-icon.png"
                        alt="section title icon" class="me-2" height="19" />
                    <span class="text-uppercase">Useful features</span>
                </h6>
                <h5 class="text-center mb-2">
                    <span class="h4 fw-bold">Everything you need</span> to start your next project
                </h5>
                ...
                <div class="features-icon-wrapper row gx-0 gy-12 gx-sm-6">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/laptop-charging.png"
                                alt="laptop charging" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/transition-up.png"
                                alt="transition up" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/edit.png"
                                alt="edit" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/3d-select-solid.png"
                                alt="3d select solid" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/lifebelt.png"
                                alt="lifebelt" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="features-icon mb-4">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/google-docs.png"
                                alt="google docs" />
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card h-100">
                                <div
                                    ...
                                    <div class="mb-4">
                                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-4.png"
                        ...
                        <div class="swiper-slide">
                            <div class="card h-100">
                                <div
                                    class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                                    <div class="mb-4">
                                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-1.png"
                                            alt="client logo" class="client-logo img-fluid" />
                                    </div>
                                    <p class="text-heading">
                                        Materio is awesome, and I particularly enjoy knowing that if I get stuck on
                                        something.
                                    </p>
                                    <div class="text-warning mb-4">
                                        <i class="icon-base ri ri-star-fill icon-24px"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="card h-100">
                                <div
                                    class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                                    <div class="mb-4">
                                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-3.png"
                                            alt="client logo" class="client-logo img-fluid" />
                                    </div>
                                    <p class="text-heading">
                        ...
                        <div class="swiper-slide">
                            <div class="card h-100">
                                <div
                                    class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                                    <div class="mb-4">
                                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-2.png"
                                            alt="client logo" class="client-logo img-fluid" />
                                    </div>
                                    <p class="text-heading">
                        ...
                        <div class="swiper-slide">
                            <div class="card h-100">
                                <div
                                    class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                                    <div class="mb-4">
                                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-5.png"
                                            alt="client logo" class="client-logo img-fluid" />
                                    </div>
                                    <p class="text-heading">
                                        “I've never used a theme as versatile and flexible as Vuexy. It's my go to for
            ...
            <div class="container">
                <div class="swiper-logo-carousel pt-lg-4 mt-12">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-1-light.png"
                            ...
                            <div class="swiper-slide">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-2-light.png"
                                    alt="client logo" class="client-logo"
                                    data-app-light-img="front-pages/branding/logo-2-light.png"
                                    data-app-dark-img="front-pages/branding/logo-2-dark.png" />
                            </div>
                            <div class="swiper-slide">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-3-light.png"
                                    alt="client logo" class="client-logo"
                                    data-app-light-img="front-pages/branding/logo-3-light.png"
                                    data-app-dark-img="front-pages/branding/logo-3-dark.png" />
                            </div>
                            <div class="swiper-slide">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-4-light.png"
                                    alt="client logo" class="client-logo"
                                    data-app-light-img="front-pages/branding/logo-4-light.png"
                                    data-app-dark-img="front-pages/branding/logo-4-dark.png" />
                            </div>
                            <div class="swiper-slide">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-5-light.png"
                                    alt="client logo" class="client-logo"
        ...
        <section id="landingTeam" class="section-py landing-team">
            <div class="container bg-icon-right position-relative">
                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/bg-right-icon-light.png"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card card-hover-border-primary mt-4 mt-lg-0 shadow-none">
                            <div class="bg-label-primary position-relative team-image-box">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-1.png"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card card-hover-border-danger mt-4 mt-lg-0 shadow-none">
                            <div class="bg-label-danger position-relative team-image-box">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-2.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                            <div class="card-body text-center">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card card-hover-border-success mt-4 mt-lg-0 shadow-none">
                            <div class="bg-label-success position-relative team-image-box">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-3.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                            <div class="card-body text-center">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card card-hover-border-info mt-4 mt-lg-0 shadow-none">
                            <div class="bg-label-info position-relative team-image-box">
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-4.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                            <div class="card-body text-center">
        ...
        <section id="landingPricing" class="section-py bg-body landing-pricing">
            <div class="container bg-icon-left position-relative">
                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/bg-left-icon-light.png"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card shadow-none">
                            <div class="card-header border-0">
                                ...
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/smiling-icon.png"
                                    alt="smiling icon" />
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    <li>
                                        <h5 class="mb-3">
                                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/list-arrow-icon.png"
                                ...
                                <div class="text-center mt-6 pt-2">
                                    <a href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo-1/front-pages/payment"
                ...
                <div class="row gy-5">
                    <div class="col-lg-5">
                        <div class="text-center">
                            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/sitting-girl-with-laptop.png
          "
        ...
        <section id="landingCTA" class="section-py landing-cta p-lg-0 pb-0 position-relative">
            <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/backgrounds/cta-bg.png"
            ...
            <div class="container">
                <div class="row align-items-center gy-5 gy-lg-0">
                    <div class="col-lg-6 text-center text-lg-start">
                        ...
                        <a href="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo-1/front-pages/payment"
                            class="btn btn-primary">Get Started<i
                                class="icon-base ri ri-arrow-right-line icon-16px ms-2 scaleX-n1-rtl"></i></a>
                    </div>
                    <div class="col-lg-6 pt-lg-12">
                        <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/cta-dashboard.png"
                    ...
                    <div class="col-lg-5">
                        <div class="card h-100">
                            <div class="bg-primary rounded text-white card-body p-lg-8">
                                ...
                                <img src="https://demos.themeselection.com/materio-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/let’s-contact.png"
