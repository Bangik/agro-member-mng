        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="{{ auth()->user()->role === 'member' && auth()->user()->member->pp_file ? auth()->user()->member->photoUrl() : asset('assets/img/avatars/1.png') }}"
            ...
            <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">{{ auth()->user()->role ?? 'Visitor' }}</small>
                            </div>
                        </div>
                    </a>
                </li>
                ...
                @if (auth()->user()->role == 'member')
                    <li>
                        <a class="dropdown-item" href="{{ route('member.profile.index') }}">
